...
public class Principal {
    ...
    static File archivoProductos = new File("archivoProductos.txt");
    static File archivoClientes = new File("archivoClientes.txt");
    static File archivoFacturas = new File("archivoFacturas.txt");
    ...
    public static void escribirProductosBin() {
        try {
            FileWriter escribir = new FileWriter(archivoProductos, true);


            escribir.write(String.valueOf(productos));
            escribir.close();
    ...
    public static void escribirClientesBin() {
        try {
            FileWriter escribir = new FileWriter(archivoClientes, true);


            escribir.write(String.valueOf(clientes));
            escribir.close();
        } catch (FileNotFoundException e) {
            System.out.println("Error. " + e);
        } catch (IOException e) {
    ...
    public static void escribirFacturasBin() {
        try {
            FileWriter escribir = new FileWriter(archivoFacturas, true);


            escribir.write(String.valueOf(facturas));
            escribir.close();
        } catch (FileNotFoundException e) {
            System.out.println("Error. " + e);
        } catch (IOException e) {
    ...
    public static void convArchProd() {
        String cadena;
        try {
            FileReader lector = new FileReader(archivoProductos);
    ...
    public static void convArchFact() {
        String cadena;
        try {
            FileReader lector = new FileReader(archivoFacturas);
            BufferedReader lectura = new BufferedReader(lector);
            cadena = lectura.readLine();
